...
FORMAT = ihex
TARGET = ardplc
SRC = main.c uart.c ds18b20.c crc8.c timer.c dht21.c
ASRC =
OPT = s
BASEADDR = 0x0000
...
AVRDUDE_PORT = $(PORT) -b $(BAUDRATE)

AVRDUDE_WRITE_FLASH = -U flash:w:$(TARGET).hex
#AVRDUDE_WRITE_EEPROM = -U eeprom:w:$(TARGET).eep

AVRDUDE_WRITE_FUSES = -U lfuse:w:0xff:m -U hfuse:w:0xde:m -U efuse:w:0x05:m
#AVRDUDE_WRITE_FUSES = -U lfuse:w:0x62:m -U hfuse:w:0xd9:m -U efuse:w:0x07:m
